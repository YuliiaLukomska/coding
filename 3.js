...
// console.log(found);
// // // 0 === 0 indexOf це завжди буде одне і те ж число, яке буде = ідексу першої зустрічі елемента який шукаємо.
// // Для математики це буде нуль.
// // // // 0 === 3 а от просто index буде змінюватись, для математики спочатку це буде 0, а потім 3.
